    ...
    return (
        <div className="profile-wrapper">
            <div className="profile-form-container">
                <div className="avatar-container" onMouseEnter={() => setIsMenuOpen(true)}
                     onMouseLeave={() => setIsMenuOpen(false)} onClick={handleAvatarClick}>
                ...
                <form className="profile-form">
                    ...
                    <div className="button-container">
                        <button type="button" className="rounded-button">Сменить пароль</button>
                        <button type="submit" className="rounded-button">Сохранить профиль</button>
                        <button type="button" className="rounded-button">Выход</button>
                        <button type="button" className="rounded-button delete-profile-button">Удалить профиль</button>
                    </div>
                </form>
            </div>
