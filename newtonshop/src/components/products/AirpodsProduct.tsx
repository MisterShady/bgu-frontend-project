...
import { fetchAirpodsById, setSelectedImage, setSelectedColor, removeNotification, addToCart } from "../slices/airpodsSlice";
...
const AirpodsProduct: React.FC = () => {
  ...
  const { item: airpods, loading, error, selectedImage, selectedColor, notifications, isAddingToCart } = useSelector((state: RootState) => state.airpods);
  useEffect(() => {
  ...
  }, [airpods, dispatch, selectedColor, selectedImage]);
